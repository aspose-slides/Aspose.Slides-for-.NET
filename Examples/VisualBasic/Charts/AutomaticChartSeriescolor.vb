...
Namespace VisualBasic.Charts
    Public Class AutomaticChartSeriescolor
        Public Shared Sub Run()
            ...
            Dim chart As IChart = slides.Shapes.AddChart(ChartType.ClusteredColumn, 0, 0, 500, 500)
            ...
            presentation.Save(dataDir & Convert.ToString("AutomaticColor.pptx"), SaveFormat.Pptx)
