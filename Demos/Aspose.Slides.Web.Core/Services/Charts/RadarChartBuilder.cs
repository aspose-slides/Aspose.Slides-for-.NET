...
{
	internal sealed class RadarChartBuilder : BaseChartBuilder
	{
		public RadarChartBuilder(ChartType chartType) : base(chartType)
		{
		}
			...
			for (var rowIndex = 0; rowIndex < rowCount; rowIndex++)
			{
				...
				for (var colIndex = 0; colIndex < colCount; colIndex++)
				{
					...
					if (cell.Type == CellValueType.IsNumeric)
					{
						...
						series.DataPoints.AddDataPointForRadarSeries(fact.GetCell(defaultWorksheetIndex, dataRow, dataColumn, cell.Value));
					}
				}
			}			
		}
