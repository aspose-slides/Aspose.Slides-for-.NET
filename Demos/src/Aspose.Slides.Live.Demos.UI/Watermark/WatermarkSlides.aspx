<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WatermarkSlides.aspx.cs" Inherits="Aspose.Slides.Live.Demos.UI.WatermarkSlides" %>
        ...
        <div class="container">
            ...
            <div class="col-md-9 pull-left">
                ...
                <ul>
                    ...
                    <li><%= Resources["slidesWatermarkLiFeature1"] %></li>
                </ul>
            </div>
        </div>
    </div>
...
<!-- HowTo Section -->
        <div class="col-md-12 tl bg-darkgray howtolist"  id="dvHowToSection" visible="false" runat="server"><div class="container tl dflex">
            ...
            <div class="col-md-4 howtosectiongfx"><img src="../../img/howto.png"  ></div><div class="howtosection col-md-8"><div><h4><i class="fa fa-question-circle "></i> <b><%= string.Format(Resources["HowtoWatermarkTitle"], ViewState["Extension1"], AsposeProductTitle.InnerText) %></b></h4><ul>
    ...
    <div class="col-md-12 pt-5 app-features-section">
        <div class="container tc pt-5">
            <div class="col-md-4">
                ...
                <h4><%= Resources["WatermarkFeature1"] %></h4>
                <p><%= Resources["WatermarkFeature1Description"] %></p>
            </div>
            <div class="col-md-4">
                <div class="imgcircle anywhere">
                    <img src="../../img/anywhere.png" />
                </div>
                <h4><%= Resources["WatermarkFeature2"] %></h4>
                <p><%= Resources["WatermarkFeature2Description"] %>.</p>
            </div>
            <div class="col-md-4">
