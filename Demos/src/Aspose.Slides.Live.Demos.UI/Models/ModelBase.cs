...
namespace Aspose.Slides.Live.Demos.UI.Models
{
	...
	public abstract class ModelBase : ApiController
	{
		...
		{
			string sourceFolder = Aspose.Slides.Live.Demos.UI.Config.Configuration.WorkingDirectory + folderName;
	  ...
	  bool deleteSourceFolder = true, string zipFileName = null)
		{
			...
			string zipOutFolder = Aspose.Slides.Live.Demos.UI.Config.Configuration.OutputDirectory + guid;
			string zipOutfileName, zipOutPath;
			if (string.IsNullOrEmpty(zipFileName))
			{
				zipOutfileName = guid + ".zip";
				zipOutPath = Aspose.Slides.Live.Demos.UI.Config.Configuration.OutputDirectory + zipOutfileName;
			}
			else
			{
				...
				zipOutPath = Aspose.Slides.Live.Demos.UI.Config.Configuration.OutputDirectory + guid2;
				if (createZip)
				{
			...
			{
				outFolder = guid;
				outPath = Aspose.Slides.Live.Demos.UI.Config.Configuration.OutputDirectory + outFolder;
