...
namespace Aspose.Slides.Live.Demos.UI.Config
{
    ...
    {
        private AsposeSlidesContext _atContext;
        ...
        public AsposeSlidesContext AsposeSlidesContext
		{
            get
            {
                if (_atContext == null) _atContext = new AsposeSlidesContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		protected override void OnLoad(EventArgs e)
        {
            ...
            AsposeSlidesContext.atcc = AsposeSlidesContext;
            base.OnLoad(e);
        }
    }
}
