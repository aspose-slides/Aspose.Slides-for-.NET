...
namespace Aspose.Slides.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _asposeSlidesLiveDemosPath = ConfigurationManager.AppSettings["AsposeSlidesLiveDemosPath"].ToString();
		...
		private static string _productsAsposeSlidesAssetURL = ConfigurationManager.AppSettings["ProductsAsposeSlidesAssetURL"];
		...
		{
			get { return _productsAsposeSlidesAssetURL; }
		}	
        ...
        public static string AsposeSlidesLiveDemosPath
        {
            get { return _asposeSlidesLiveDemosPath; }
        }
